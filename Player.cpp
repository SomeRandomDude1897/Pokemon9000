...
{
	// Здесь мы знаем только тип покемона и соответственно мне нужно создать соответствующего наследника Pokemon, поэтому тут я сильно много не смогу порезать
